...
noise-manufactured at any plausible falseRate. The `observedCeilingExcess` field in the
classification artifact is updated from "observed, not established" to "observed,
noise-correction-surviving" — the classification stays MIXED/INCONCLUSIVE.
