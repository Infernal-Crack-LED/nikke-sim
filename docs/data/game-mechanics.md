...
(owner rulings 2026-08-16, Union shooting-range observations; per-skill exceptions and the
anti-double-count rule for bullet-delivered effects apply — see burst-gauge.md §5; engine:
`applicationGauge`). Ally/self-targeted pure buffs, heals, and shields generate nothing.
