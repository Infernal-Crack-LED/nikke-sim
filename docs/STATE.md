...
| `RIDERCRIT`                                                | **ON**                                 | `extraHitDamagePct` function-rider hits roll crit at caster rate (core stays OFF; FB by landing time). Carriers: `modernia`, `nayuta`, `neon-blue-ocean`, `neon-vision-eye`. Since 2026-08-13 the same call site also emits `skillGauge` per impact, matching an equivalent `flatDamage` rider (U28 gauge half; no board movement — the ≤10s riders sit inside the chain+FB gauge lock by mechanism, `modernia`'s 15s by measurement only: `scripts/battery/u28-gauge-ab.ts --lock-census`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | `RIDERCRIT=off`                                                                              | → DECISIONS 2026-07-22                |
