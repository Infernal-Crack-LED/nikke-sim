...
| `POST_FB_CHAIN_DELAY_FRAMES`                | 150 (~2.5s), **inactive**                                | Old fixed post-FB chain-open block; OVERTURNED as a game mechanic 2026-08-04 (owner) — live ONLY under `ROTMODEL=floor` for A/B | :1114    |
