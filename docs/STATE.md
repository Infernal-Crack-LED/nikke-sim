...
| `fbGate` (`inFb`/`outFb`)          | Only inside / outside Full Burst                                                                                                                                      | moran, modernia, soda-twinkling-bunny, zwei, velvet |
...
| Primitive                   | Meaning                                                | Users                                                                                                                                                                                                                  |
| --------------------------- | ------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `hasPierce` / `pierceModes` | Permanently Pierce-tagged / Pierce only in named modes | alice, mari, red-hood, zwei / cinderella-crystal-wave, zwei                                                                                                                                                            |
