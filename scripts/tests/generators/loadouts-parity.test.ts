...
describe('makeCalc loadouts map ≡ loadoutFor (item 1a parity gate)', () => {
  ...
  // The stronger of the two parity gates: topTeams(5) runs the full greedy build PLUS
  // the item-4 cross-team polish (2 re-build passes) and count-repair, so it exercises
  // loadout resolution on paths bestTeam never reaches.
