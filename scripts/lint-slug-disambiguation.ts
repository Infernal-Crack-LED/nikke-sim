...
const byBase = new Map<
  string,
  { slug: string; w: string; el: string; nicks: string[] }[]
>();
...
// No file arg + interactive TTY stdin → readFileSync(0) would block forever waiting on
// stdin. Bail with a hint instead. Non-interactive callers (agents, CI) MUST pipe input
