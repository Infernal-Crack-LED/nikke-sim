# CROSS-FAMILY BLIND PACKET — role s2b — unit guilty
...
Unit: Guilty (guilty)
Base: SG/Wind/Attacker/Burst II, cd 20s, ammo 9, reloadFrames 181, chargeFrames 0, hitsPerShot 10, normalAttackMultiplier 231.4, coreAttackMultiplier 200.

skill1:
■ Activates after 6 normal attacks. Affects self.
...
skill2:
■ Activates after 12 normal attacks. Affects all Wind Code allies.
Increases stack count of stackable buffs by 1.
ATK ▲ 4.13% for 10 sec.

burst:
■ Affects the 1 enemy unit(s) with the highest final DEF.
