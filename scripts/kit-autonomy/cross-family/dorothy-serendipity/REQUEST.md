# Cross-family review REQUEST — `dorothy-serendipity`
...
| --- | --- | --- | --- |
| s5 | cross-family/dorothy-serendipity/s5-packet.md | BLIND-TEST-WRITER output contract | cross-family/dorothy-serendipity/s5-result.json |
| s6 | cross-family/dorothy-serendipity/s6-packet.md | BLIND-OVERRIDE-WRITER output contract | cross-family/dorothy-serendipity/s6-result.json |
