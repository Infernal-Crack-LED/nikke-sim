# Cross-family review REQUEST — `bready`
...
| --- | --- | --- | --- |
| s5 | cross-family/bready/s5-packet.md | BLIND-TEST-WRITER output contract | cross-family/bready/s5-result.json |
| s6 | cross-family/bready/s6-packet.md | BLIND-OVERRIDE-WRITER output contract | cross-family/bready/s6-result.json |
