# CROSS-FAMILY BLIND PACKET — role s2b — unit diesel-winter-sweets
...
Unit: Diesel: Winter Sweets (diesel-winter-sweets)
Base: RL/Fire/Attacker/Burst III, cd 40s, ammo 6, reloadFrames 141, chargeFrames 60, hitsPerShot 1, normalAttackMultiplier 61.3, coreAttackMultiplier 200.

skill1:
■ Activates when entering Full Burst for the first time after using Burst Skill. Affects self.
