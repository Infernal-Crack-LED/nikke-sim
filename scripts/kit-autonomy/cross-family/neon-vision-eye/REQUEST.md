# Cross-family review REQUEST — `neon-vision-eye`
...
| --- | --- | --- | --- |
| s5 | cross-family/neon-vision-eye/s5-packet.md | BLIND-TEST-WRITER output contract | cross-family/neon-vision-eye/s5-result.json |
| s6 | cross-family/neon-vision-eye/s6-packet.md | BLIND-OVERRIDE-WRITER output contract | cross-family/neon-vision-eye/s6-result.json |
