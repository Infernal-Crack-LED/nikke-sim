# CROSS-FAMILY BLIND PACKET — role s2b — unit helm-aquamarine
...
Unit: Helm: Aquamarine (helm-aquamarine)
Base: AR/Iron/Attacker/Burst II, cd 20s, ammo 60, reloadFrames 81, chargeFrames 0, hitsPerShot 1, normalAttackMultiplier 13.65, coreAttackMultiplier 200.

skill1:
■ Activates after landing 30 normal attacks. Affects the target.
...
skill2:
■ Affects 1 enemy unit(s) randomly.
