# Cross-family review REQUEST — `guillotine-winter-slayer`
...
| --- | --- | --- | --- |
| s5 | cross-family/guillotine-winter-slayer/s5-packet.md | BLIND-TEST-WRITER output contract | cross-family/guillotine-winter-slayer/s5-result.json |
| s6 | cross-family/guillotine-winter-slayer/s6-packet.md | BLIND-OVERRIDE-WRITER output contract | cross-family/guillotine-winter-slayer/s6-result.json |
