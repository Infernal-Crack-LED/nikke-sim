# Cross-family review REQUEST — `quency-escape-queen`
...
| --- | --- | --- | --- |
| s5 | cross-family/quency-escape-queen/s5-packet.md | BLIND-TEST-WRITER output contract | cross-family/quency-escape-queen/s5-result.json |
| s6 | cross-family/quency-escape-queen/s6-packet.md | BLIND-OVERRIDE-WRITER output contract | cross-family/quency-escape-queen/s6-result.json |
