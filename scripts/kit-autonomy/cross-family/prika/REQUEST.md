# Cross-family review REQUEST — `prika`
...
| --- | --- | --- | --- |
| s5 | cross-family/prika/s5-packet.md | BLIND-TEST-WRITER output contract | cross-family/prika/s5-result.json |
| s6 | cross-family/prika/s6-packet.md | BLIND-OVERRIDE-WRITER output contract | cross-family/prika/s6-result.json |
