# Cross-family review REQUEST — `rapi-red-hood`
...
| --- | --- | --- | --- |
| s5 | cross-family/rapi-red-hood/s5-packet.md | BLIND-TEST-WRITER output contract | cross-family/rapi-red-hood/s5-result.json |
| s6 | cross-family/rapi-red-hood/s6-packet.md | BLIND-OVERRIDE-WRITER output contract | cross-family/rapi-red-hood/s6-result.json |
