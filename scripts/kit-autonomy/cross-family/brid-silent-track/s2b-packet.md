# CROSS-FAMILY BLIND PACKET — role s2b — unit brid-silent-track
...
Unit: Brid: Silent Track (brid-silent-track)
Base: SG/Fire/Supporter/Burst II, cd 20s, ammo 9, reloadFrames 111, chargeFrames 0, hitsPerShot 10, normalAttackMultiplier 201.5, coreAttackMultiplier 200.

skill1:
■ Activates when entering Full Burst. Affects all Wind Code enemies.
