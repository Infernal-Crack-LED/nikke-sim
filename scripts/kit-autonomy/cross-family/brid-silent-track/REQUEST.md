# Cross-family review REQUEST — `brid-silent-track`
...
| --- | --- | --- | --- |
| s5 | cross-family/brid-silent-track/s5-packet.md | BLIND-TEST-WRITER output contract | cross-family/brid-silent-track/s5-result.json |
| s6 | cross-family/brid-silent-track/s6-packet.md | BLIND-OVERRIDE-WRITER output contract | cross-family/brid-silent-track/s6-result.json |
