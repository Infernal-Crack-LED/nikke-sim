# CROSS-FAMILY BLIND PACKET — role s2b — unit velvet
...
Unit: Velvet (velvet)
Base: SR/Wind/Supporter/Burst II, cd 20s, ammo 6, reloadFrames 141, chargeFrames 60, hitsPerShot 1, normalAttackMultiplier 69.04, coreAttackMultiplier 200.
...
skill2:
■ Activates when attacking with Full Charge during Full Burst.
Function: Strengthens allies by expending ammo from the ammo pouch.
...
Function: Expends ammo from the ammo pouch to deal additional damage to the enemy.
Effect 1: Affects self. Expends ammo from the ammo pouch. Amount: 300 round(s).
...
Damage: 7% of final ATK.
Duration: 10 sec.
Additional Effect
Attack Damage ▲ 34.52% for 10 sec.
=== END KIT PROSE ===
