# Cross-family review REQUEST — `modernia`
...
| --- | --- | --- | --- |
| s5 | cross-family/modernia/s5-packet.md | BLIND-TEST-WRITER output contract | cross-family/modernia/s5-result.json |
| s6 | cross-family/modernia/s6-packet.md | BLIND-OVERRIDE-WRITER output contract | cross-family/modernia/s6-result.json |
