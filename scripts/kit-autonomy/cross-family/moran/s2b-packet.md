# CROSS-FAMILY BLIND PACKET — role s2b — unit moran
...
Unit: Moran (moran)
Base: AR/Electric/Defender/Burst I, cd 40s, ammo 60, reloadFrames 111, chargeFrames 0, hitsPerShot 1, normalAttackMultiplier 14.71, coreAttackMultiplier 200.
...
skill2:
■ Activates when firing the final bullet. Affects the 3 enemy unit(s) with the highest final ATK.
Taunts for 4 sec.
