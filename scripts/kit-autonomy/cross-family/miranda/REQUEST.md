# Cross-family review REQUEST — `miranda`
...
| --- | --- | --- | --- |
| s5 | cross-family/miranda/s5-packet.md | BLIND-TEST-WRITER output contract | cross-family/miranda/s5-result.json |
| s6 | cross-family/miranda/s6-packet.md | BLIND-OVERRIDE-WRITER output contract | cross-family/miranda/s6-result.json |
