# CROSS-FAMILY BLIND PACKET — role s2b — unit miranda
...
Unit: Miranda (miranda)
Base: SMG/Fire/Supporter/Burst I, cd 20s, ammo 120, reloadFrames 107, chargeFrames 0, hitsPerShot 1, normalAttackMultiplier 10.8, coreAttackMultiplier 250.
...
burst:
■ Affects 2 ally unit(s) with the highest final ATK (except the skill user; including the skill user if there are not enough allies). 
ATK ▲ 40.4% for 10 sec. 
