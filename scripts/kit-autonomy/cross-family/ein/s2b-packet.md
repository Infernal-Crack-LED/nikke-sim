# CROSS-FAMILY BLIND PACKET — role s2b — unit ein
...
Unit: Ein (ein)
Base: SR/Electric/Attacker/Burst III, cd 40s, ammo 6, reloadFrames 141, chargeFrames 60, hitsPerShot 1, normalAttackMultiplier 69.04, coreAttackMultiplier 200.
...
skill2:
■ Activates when Near Feather is summoned. Affects 1 random enemy unit(s).
