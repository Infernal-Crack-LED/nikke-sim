# Cross-family review REQUEST — `cinderella-crystal-wave`
...
| --- | --- | --- | --- |
| s5 | cross-family/cinderella-crystal-wave/s5-packet.md | BLIND-TEST-WRITER output contract | cross-family/cinderella-crystal-wave/s5-result.json |
| s6 | cross-family/cinderella-crystal-wave/s6-packet.md | BLIND-OVERRIDE-WRITER output contract | cross-family/cinderella-crystal-wave/s6-result.json |
