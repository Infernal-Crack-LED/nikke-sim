...
describe('anis-sparkling-summer - blind kit spec', () => {
  ...
  it('S2 rider gets NO core and NO +30% range, but DOES take the Full Burst major by timing', () => {
    ...
    for (const r of outFb) {
      expect(r.fbMajorApplied === true).toBe(false);
    }
  });
