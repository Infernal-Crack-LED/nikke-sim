// REDACTED effect schema for blind kit-authoring roles (kit-autonomy stage 0). One per-unit example
// comment was removed to keep this file answer-free; every type definition below is unchanged.
