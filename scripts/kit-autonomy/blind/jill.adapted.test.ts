// ADAPTED (driver, S5-landing): identical to jill.test.ts (the blind S5 artifact) except the
// harness import path is corrected to the real location (../../tests/lib/harness.js). Run against
// the DRIVER override on disk (loadOverride/withPatchedOverride read src/skills/overrides/jill.json).
/**
