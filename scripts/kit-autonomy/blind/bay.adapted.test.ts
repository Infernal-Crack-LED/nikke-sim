// ADAPTED-COPY (driver, 2026-08-03) — structural fixes only, assertion intent untouched:
//   1. harness import path: '../lib/harness.js' -> '../../tests/lib/harness.js'
//      (the pristine blind artifact assumes it lives under scripts/tests/units/).
// The pristine blind/bay.test.ts is preserved untouched alongside this file.
/**
