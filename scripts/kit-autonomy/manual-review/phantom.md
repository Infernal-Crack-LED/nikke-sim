...
> below prove _stability_, not _correctness_ — the S7 judge flagged this explicitly and the owner
...
- **S6 (kimi-code/k3, blind override):** `leakDetected:null`. Independently re-derived the SAME
  ...
  entirely, and declared the 12.86% burst-reset _unmodelable_ where the driver modeled it exactly via
