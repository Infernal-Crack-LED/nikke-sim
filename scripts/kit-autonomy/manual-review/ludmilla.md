...
- **S2b (claude-fable-5, test-faithfulness review):** `leakDetected:null`. Agreed on 5 of 6 lines.
  ...
  SSOT refutes the premise: scope lock runs bossDef=0 (owner DECISION, damage-calculation.md line 32) and sim.ts applyEffect drops enemy ATK▼/DEF▼ debuffs ("other enemy debuffs (ATK▼, DEF▼)
