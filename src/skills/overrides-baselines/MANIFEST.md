...
| isabel | SG B3 | escalating Marked-Target riders (no-core, text-faithful) | kit-silent S2 trigger (TOP) | **SG-capped**, HR-clean |
...
| brid-silent-track | SG B3 | FB riders + element-gated damage-taken | shot-vs-pellet count | **SG-capped** |
...
- Kit-silent invented triggers (helm-aquamarine S2a, mari S2, isabel S2) are the top per-unit uncertainty
  and the #1 recording priority for those units.
